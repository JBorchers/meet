...
defineFeature(feature, test => {
  test('When user hasn’t searched for a city, show upcoming events from all cities.', ({ given, when, then }) => {
    ...
    // AppWrapper is defined outside of the *when* step because it's needed in more than one step
    let AppWrapper;
  ...
  test('User can select a city from the suggested list', ({ given, and, when, then }) => {
    ...
    // concatenator, requiring two different preconditions for the test to be executed
    // code should check whenter a list of suggested cities is showing in the body of *and*
